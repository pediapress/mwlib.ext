#!/usr/bin/env python
'''
$Id: test_xmltestsuite.py 1938 2003-04-13 16:04:04Z rgbecker $
...
'''
__rcs_id__	= '$Id: test_xmltestsuite.py 1938 2003-04-13 16:04:04Z rgbecker $'
__version__ = '$Revision: 1938 $'[11:-2]
